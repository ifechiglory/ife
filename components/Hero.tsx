      ...
      <div className="max-w-[640px]">
        ...
        >
          ...
          >
            <a
              href="#work"
              className="group relative inline-flex items-center gap-2.5 rounded-[3px] border border-paper bg-paper px-[24px] py-[13px] font-mono text-sm text-bg transition-[color,border-color,box-shadow] duration-300 hover:border-pine hover:text-bg hover:shadow-[0_8px_24px_rgba(47,122,82,0.35)]"
            >
        ...
        >
          {["React", "TypeScript", "Tailwind CSS", "GSAP", "Motion"].map((tech) => (
            <motion.span
              ...
              className="rounded-full border border-line bg-paper/[0.04] px-3 py-1.5 font-mono text-xs text-stone"
            >
              {tech}
            </motion.span>
          ))}
      ...
      >
        ...
        >
          ...
          >
            ...
            <div className="flex items-center gap-2 border-b border-white/[0.06] bg-[#232427] px-[18px] py-[14px]">
              <span className="h-[11px] w-[11px] rounded-full bg-[#E5675F]" />
              <span className="h-[11px] w-[11px] rounded-full bg-[#E6B450]" />
            ...
            <div className="px-6 py-[26px] pb-[30px] font-mono text-[13.5px] leading-[1.9]">
              <div data-cmd="1" className="flex -translate-x-1.5 opacity-0">
                ...
                <span className="whitespace-pre text-on-dark/90">
                  ...
                  <span data-caret="1" className="ml-px inline-block h-[15px] w-[7px] bg-brass align-text-bottom" />
                </span>
              </div>
              <div data-output="1a" className="pl-[22px] text-on-dark/50 opacity-0">
                core&nbsp;&nbsp;&nbsp;&nbsp;<span className="text-[#E6B450]">React · TypeScript · Next.js</span>
              </div>
              <div data-output="1b" className="pl-[22px] text-on-dark/50 opacity-0">
                style&nbsp;&nbsp;&nbsp;&nbsp;<span className="text-[#E6B450]">Tailwind CSS · Framer Motion</span>
              </div>
              <div data-output="1c" className="pl-[22px] text-on-dark/50 opacity-0">
                motion&nbsp;&nbsp;<span className="text-[#E6B450]">GSAP · Motion</span>
              </div>
              <div data-output="1d" className="pl-[22px] text-on-dark/50 opacity-0">
              ...
              <div data-cmd="2" className="mt-0 flex -translate-x-1.5 opacity-0">
                ...
                <span className="whitespace-pre text-on-dark/90">
                  ...
                  <span data-caret="2" className="ml-px inline-block h-[15px] w-[7px] bg-brass align-text-bottom" />
                </span>
              </div>
              <div data-output="2" className="pl-[22px] text-[#7FB88F] opacity-0">
              ...
              <div data-cmd="3" className="mt-0 flex -translate-x-1.5 opacity-0">
                ...
                <span className="whitespace-pre text-on-dark/90">
                  ...
                  <span data-caret="3" className="ml-px inline-block h-[15px] w-[7px] bg-brass align-text-bottom" />
                </span>
              </div>
              <div data-output="3" className="pl-[22px] text-[#7FB88F] opacity-0">
                <span>✓ 2+ years, 2 institutions</span>
                <span data-caret="4" className="ml-px inline-block h-[15px] w-[7px] bg-brass align-text-bottom opacity-0" />
              </div>
            </div>

            <div className="flex justify-between border-t border-white/[0.06] bg-[#232427] px-[18px] py-3 font-mono text-[11px] text-on-dark/35">
          ...
          <motion.div
            ...
            className="absolute -right-4.5 -bottom-6 hidden max-w-[220px] rounded-lg border border-brass/25 bg-surface-raised p-[14px_16px] font-body text-[12.5px] leading-[1.5] text-ink-soft shadow-[0_20px_45px_-10px_rgba(0,0,0,0.55)] lg:block"
          >
